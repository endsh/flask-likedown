...
def index():
    form = EntryForm(request.form, obj=Simple())
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--debug', action="store_true", default=False, help='run server as debug mode.')
